...
![Authentication vs. Authorization](/.eraser/KLZue7jaYy17up7ars6z___reS6fUv66LcKWYn8yV2OvCPvwSm2___---figure---mCIYoE9X--AGheh62Pz_i---figure---OwhBpV6P4s8P6VTewGggjw.png "Authentication vs. Authorization")
...
![Authorization Code Flow (server-side)](undefined "Authorization Code Flow (server-side)")
...
![Authorization Code Flow + PKCE (client-side)](/.eraser/KLZue7jaYy17up7ars6z___reS6fUv66LcKWYn8yV2OvCPvwSm2___---figure---2WW1cnYSNrRU120nFptBQ---figure---KKnxszkYdMsKW6PTNDNi-g.png "Authorization Code Flow + PKCE (client-side)")
